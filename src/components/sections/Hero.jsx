        ...
        <div id='Home' className='h-screen'>
            <div className='max-w-[1200px]  mt-[-96px] px-6  md:px-24  h-[84vh] w-full mx-auto text-center flex flex-col justify-center'>
                ...
                <div className='posTitle flex justify-center items-center flex-wrap md:py-4'>
                    ...
                    <ReactTyped className='md:text-3xl-cm sm:text-4xl text-2xl text-[var(--priColor)]  font-montserrat font-bold italic pl-2 ' strings={['Front End Developer', 'Seo', 'Virtual Assistant']} typeSpeed={140} backSpeed={90} loop />
                </div>
            </div>
        </div>
    )
