...
const Sidebar = () => {
    ...
    return (
        <div className='relative'>
            <div className='socialsLink hidden sm:block fixed w-10 left-[2.5rem] bottom-0 text-[var(--lightest-slate)]'>
            ...
            <div className='hidden sm:block fixed w-10 right-[1rem] bottom-0 z-10 text-[var(--lightest-slate)]'>
